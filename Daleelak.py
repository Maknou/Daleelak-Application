...
if filename :
     ...
     if menu_id == "Home":
         ...
         cc = st.columns(5)
         with cc[0]:
             hc.info_card(title='Distinct Professions',title_text_size="2.2 rem", content=jobs_value, theme_override=theme_1)

         with cc[1]:
             hc.info_card(title='Job Vacancies',title_text_size="2.2 rem", content=num_of_titles, theme_override=theme_2)
         ...
         with w2:
             ...
             fig511=px.bar(top_intervention_1, y="index", x="counts",text='counts', title="Job Postings in relation to Intervention Sector",color_discrete_sequence=['#074650'],height=500,width=1000,orientation='h')
